...
static const uint8_t TILE_X[MAX_VIDEO_TILES] = {
    [ONE_BOMB] = TILE_POS_X(0, 0),
    [TWO_BOMBS] = TILE_POS_X(1, 0),
    [THREE_BOMBS] = TILE_POS_X(2, 0),
    [FOUR_BOMBS] = TILE_POS_X(3, 0),
    [FIVE_BOMBS] = TILE_POS_X(4, 0),
    [SIX_BOMBS] = TILE_POS_X(5, 0),
    [SEVEN_BOMBS] = TILE_POS_X(6, 0),
    ...
    [BOMB] = TILE_POS_X(0, 1),
    [FLAG] = TILE_POS_X(1, 1),
    [QUESTION_MARK] = TILE_POS_X(2, 1),
    [EXPLOSION] = TILE_POS_X(3, 1),
    [GROUND] = TILE_POS_X(4, 1),
