...
void set_tile(uint8_t dst_x, uint8_t dst_y, uint8_t tile)
{
    ...
    switch(tile) {
        ...
        case MINEFIELD_CORNER_TOP_LEFT: draw_minefield_border(12, 12, RIGHT | DOWN); break;
        case MINEFIELD_TOP_TEE: draw_minefield_border(12, 12, RIGHT | DOWN | LEFT); break;
        case MINEFIELD_HORIZONTAL_TOP: draw_minefield_border(12, 12, LEFT | RIGHT); break;
        case MINEFIELD_HORIZONTAL_MIDDLE: draw_minefield_border(12, 12, LEFT | RIGHT); break;
        case MINEFIELD_HORIZONTAL_BOTTOM: draw_minefield_border(12, 12, LEFT | RIGHT); break;
        case MINEFIELD_CORNER_TOP_RIGHT: draw_minefield_border(12, 12, LEFT | DOWN); break;

        case MINEFIELD_LEFT_TEE: draw_minefield_border(12, 12, DOWN | RIGHT | UP); break;
        case MINEFIELD_CROSS: draw_minefield_border(12, 12, DOWN | RIGHT | UP | LEFT); break;
        case MINEFIELD_RIGHT_TEE: draw_minefield_border(12, 12, DOWN | UP | LEFT); break;

        case MINEFIELD_VERTICAL_LEFT: draw_minefield_border(12, 12, DOWN | UP); break;
        case MINEFIELD_VERTICAL_MIDDLE: draw_minefield_border(12, 12, DOWN | UP); break;
        case MINEFIELD_VERTICAL_RIGHT: draw_minefield_border(12, 12, DOWN | UP); break;
        case CLOSED_CELL: draw_brick(12, 12, 3); break;

        case MINEFIELD_CORNER_BOTTOM_LEFT: draw_minefield_border(12, 12, RIGHT | UP); break;
        case MINEFIELD_BOTTOM_TEE: draw_minefield_border(12, 12, RIGHT | UP | LEFT); break;
        case MINEFIELD_CORNER_BOTTOM_RIGHT: draw_minefield_border(12, 12, UP | LEFT); break;
